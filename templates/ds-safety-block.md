...
| Pattern | Example | Why |
|---------|---------|-----|
| Hardcoded hex colors | `#fff`, `#1a2b3c`, `color: #333` | Use semantic tokens from DS-REFERENCE |
...
| Unapproved GSAP animation | Animating `width`, `height`, `top` | See DS-REFERENCE § Animation Rules |
